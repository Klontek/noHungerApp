...
const ShopHomeScreen = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        <View>
          <ShopHeader id={id} navigation={navigation} image={image} />

          {discount && (
            <View style={styles.view1}>
              <Text style={styles.text1}>
                GET {discount}% OFF ON FOOD TOTAL
              </Text>
            </View>
          )}
          ...
          <View style={styles.view2}>
            <View style={styles.view3}>
              <Text style={styles.text2}>{shopName}</Text>
              <Text style={styles.text3}>{foodType}</Text>
              ...
              <View style={styles.view4}>
                ...
                <Text style={styles.text5}>({numReviews})</Text>
                ...
                <Icon
                  ...
                  size={15}
                />
                <Text style={styles.text6}>{farAway} km away</Text>
              </View>
            </View>
            ...
            <View style={styles.view5}>
              ...
              <View style={styles.view7}>
                <Text style={styles.text7}>{collectTimes}</Text>
              ...
              <View style={styles.view8}>
                ...
                <View style={styles.view9}>
                  <Text style={styles.text9}>{deliveryTimes}</Text>
        ...
        {index === 0 && <MenuScreen onPress={menuPress} />}
      </ScrollView>
