    ...
    <DrawerContentScrollView {...props}>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center', paddingLeft: 20, paddingVertical: 10}}>
        <Avatar
          ...
          size={75}
          source={require("../../assets/profile_pics/passport_1.jpeg")}
          />

          <View style={{marginLeft: 10}}>
            <Text style={{fontWeight: 'bold', color: colors.CardBackground, fontSize: 18}}>Onwe Joseph</Text>
            <Text style={{color: colors.CardBackground, fontSize:14}}>Joe2Sure1@gmail.com</Text>
          </View>
      </View>
      ...
      <View style={{flexDirection: 'row', justifyContent: 'space-evenly', paddingBottom: 5}}>
            ...
            <View style={{flexDirection: 'row'}}>
              <View style={{ alignItems: 'center', justifyContent:'center'}}>
                ...
                <Text style={{color: colors.CardBackground, fontSize: 14}}>My Basket</Text>
              </View>
            </View>
      </View>
